    ...
    <div class="container">
        <div class="row">
            <div class="register-bar-first text-center col-sm-10 col-sm-offset-1">
                <p class="fc-color4 cta">Firm Exchange is the modern approach to buying a small business, with features built to help make your deal a success.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-push-4 content-right">
            	<h3>Listing Completion Rating</h3>
...
<div class="feature-half">
    <div class="container">
        <div class="row">
            <div class="col-md-8 content-left">
            	<h3>Historical Financials Tool</h3>
    ...
    <div class="container">
        <div class="row">
        	<div class="col-sm-10 col-sm-offset-1">
        		...
        		<p><strong>Unique deal space brings all parties together and offers a one-stop-shop for the entire due diligence process.</strong></p>
