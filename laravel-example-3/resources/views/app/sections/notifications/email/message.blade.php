@if($is_inquiry)
You have received a new Business Inquiry message on FirmExchange.com.  The details are as follows:
...
@endcomponent
@else
A new message has been added to a Diligence Center conversation in an Exchange Space of which you are a member.  The details are as follows:
