...
namespace App\Support\DetectDevice;

use App\Support\DetectDevice\MobileDetect;
...
class Detect
{
    ...
    private static function getIp()
    {
        ...
        if (isset($_SERVER['HTTP_CLIENT_IP']) && !empty($_SERVER['HTTP_CLIENT_IP'])) {
            self::$ipAddress = isset($_SERVER['HTTP_CLIENT_IP']) ?? '';
        } elseif (isset($_SERVER['HTTP_X_FORWARDED_FOR']) && !empty($_SERVER['HTTP_X_FORWARDED_FOR'])) {
            self::$ipAddress = isset($_SERVER['HTTP_X_FORWARDED_FOR']) ?? '';
        } else {
            self::$ipAddress = isset($_SERVER['REMOTE_ADDR']) ?? '';
        }
